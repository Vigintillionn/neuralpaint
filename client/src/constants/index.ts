const surpriseMePrompts: string[] = [
  ...
  'A cat riding a unicycle on the moon.',
  'A giraffe playing basketball with aliens.',
  'A penguin dressed as a superhero saving a fish from a shark',
  'A turtle racing a hare while they balance pizzas on their heads.',
  'A group of monkeys play rock-paper-scissors with robots.',
  'An elephant playing the guitar while floating in space.',
  'A unicorn doing a magic trick for a group of owls.',
];
