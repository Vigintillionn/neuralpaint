...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-gunmetal text-4xl">Create</h1>
        <p className="mt-2 text-silver text-base max-w-[500px]">Create imaginative and visually stunning images through DALL-E ai and share them with the community.</p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-silver text-base">Once you have created the image you want, you can share it with others in the community.</p>
          <button
            type="submit"
